...
import eu.ist_phosphorus.harmony.translator.idc.implementation.CancelRequestTranslator;
import eu.ist_phosphorus.harmony.translator.idc.implementation.IDCClient;
import eu.ist_phosphorus.harmony.translator.idc.implementation.ManagementRequestTranslator;
...
public final class ReservationHandler extends CommonReservationHandler {
    ...
    /** The IDC client */
    private final IDCClient idcClient = new IDCClient();
    ...
    public CancelReservationResponseType cancelReservation(
        ...
        final CancelReservation idcRequest =
        ...
        gri.setGri(idcRequest.getCancelReservation().getGri());

        harmonyResponse = new CancelReservationResponseType();
        harmonyResponse.setSuccess(true);
        this.idcClient.cancelReservation(gri);
        /* ------------------------------------------------------------------ */
    ...
    public CreateReservationResponseType createReservation(
        ...
        final CreateReply reply = this.idcClient.createReservation(idcRequest);
    ...
    public GetReservationsResponseType getReservations(
        ...
        final ListRequest idcRequest = this.mngTranslator.convert(request);
        final GetReservationsResponseType harmonyResponse =
                this.mngTranslator.convert(this.idcClient
                        .listReservations(idcRequest));
    ...
    public IsAvailableResponseType isAvailable(final IsAvailableType request)
        ...
        final IsAvailableResponseType harmonyResponse =
                this.mngTranslator.simulateIsAvailable(this.idcClient
                        .listReservations(idcRequest), request);
        return harmonyResponse;
    }
