...
import eu.ist_phosphorus.harmony.translator.idc.implementation.interfaces.IOscarsClient;

/**
 * @author Alexander Willner (willner@cs.uni-bonn.de)
 */
public class SimpleIdcClient extends Client implements IOscarsClient {
     ...
     * @throws AxisFault
     */
    public SimpleIdcClient() throws AxisFault {
        super();

        String repo = Config.getString("translatorIDC", "idc.repo");
        final String epr = Config.getString("translatorIDC", "idc.epr");
        ...
        if (Config.isTrue("translatorIDC", "idc.fetchTopology")) {
            try {
    ...
    public QueryReservationResponse queryReservation(
            final QueryReservation idcRequest) throws Exception {
        final ResDetails param =
                this.queryReservation(idcRequest.getQueryReservation());
