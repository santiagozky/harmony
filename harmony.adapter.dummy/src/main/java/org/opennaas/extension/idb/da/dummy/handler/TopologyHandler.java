...
package org.opennaas.extension.idb.da.dummy.handler;
...
import org.opennaas.extension.idb.serviceinterface.topology.CommonTopologyHandler;
...
public final class TopologyHandler extends CommonTopologyHandler {
    ...
    public AddEndpointResponseType addEndpoint(final AddEndpointType request) {
        final AddEndpointResponseType responseType =
                new AddEndpointResponseType();
        responseType.setSuccess(true);
    ...
    public DeleteDomainResponseType deleteDomain(final DeleteDomainType request) {
        final DeleteDomainResponseType responseType =
                new DeleteDomainResponseType();
        responseType.setSuccess(true);
    ...
    public DeleteEndpointResponseType deleteEndpoint(
        ...
        final DeleteEndpointResponseType responseType =
                new DeleteEndpointResponseType();
        responseType.setSuccess(true);
    ...
    public DeleteLinkResponseType deleteLink(final DeleteLinkType request) {
        final DeleteLinkResponseType responseType =
                new DeleteLinkResponseType();
        responseType.setSuccess(true);
    ...
    public EditDomainResponseType editDomain(final EditDomainType request) {
        ...
        final EditDomainResponseType responseType =
                new EditDomainResponseType();
        responseType.setSuccess(true);
    ...
    public EditEndpointResponseType editEndpoint(final EditEndpointType request) {
        final EditEndpointResponseType responseType =
                new EditEndpointResponseType();
        responseType.setSuccess(true);
    ...
    public GetEndpointsResponseType getEndpoints(final GetEndpointsType request) {
        final GetEndpointsResponseType responseType =
                new GetEndpointsResponseType();
        final EndpointType epInfo = new EndpointType();
        epInfo.setEndpointId("128.0.0.1");
