...
public class ProxyInterfaceSynthesizer extends AbstractSynthesizer {
    ...
    private Map<String, Object>[] _capabilityMaps;
    ...
    protected void generateCode(final Document wsdl,
        ...
        for (final Object name : capabilityMap.values()) {
         Capability capabilityTemp;
        try{
        capabilityTemp= (Capability) name;
        }catch(Exception e){
         System.err.println("error: "+e.getMessage());
         capabilityTemp =new Capability( name.toString());
        }
          final Capability capability= capabilityTemp;
    ...
    private Class<?> getBaseClientClass(final Map<String, Object> capabilityMap) {
    ...
    protected void loadParameters(final ConfigurationData data) {
        this._generateCustomHeaders = ((Boolean) data
                ...
                .booleanValue();
        this._capabilityMaps = (Map<String, Object>[]) data
