package org.opennaas.extension.gmpls.client.views.components;
...
import org.opennaas.extension.gmpls.client.utils.EndpointListSorter;
...
public class EndpointTable extends AbstractTableModel {
	...
	if (oList.get(0).getClass() == EndpointType.class) {
	...
	} else if (oList.get(0).getClass() == org.opennaas.extension.idb.serviceinterface.databinding.jaxb.EndpointType.class) {
	    List<EndpointType> endpointList = new ArrayList<EndpointType>(0);
	    for (Object object : oList) {
		org.opennaas.extension.idb.serviceinterface.databinding.jaxb.EndpointType harmonyEndpoint = (org.opennaas.extension.idb.serviceinterface.databinding.jaxb.EndpointType) object;
		...
		if (harmonyEndpoint.getInterface() == org.opennaas.extension.idb.serviceinterface.databinding.jaxb.EndpointInterfaceType.BORDER) {
