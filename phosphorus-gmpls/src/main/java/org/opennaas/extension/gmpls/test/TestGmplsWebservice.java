...
public class TestGmplsWebservice {
	...
	public final void testCreateDeletePath()
		...
		if (TestGmplsWebservice.serviceAvailable) {
			for (int i = 0; i < 1; i++) {
				...
				final org.opennaas.extension.gmpls.serviceinterface.databinding.jaxb.CreatePathResponseType response = GmplsWS
				...
				final org.opennaas.extension.gmpls.serviceinterface.databinding.jaxb.TerminatePathResponseType response2 = GmplsWS
	...
	public final void testTerminatePath() throws InvalidRequestFaultException,
		...
		if (TestGmplsWebservice.serviceAvailable) {
			...
			final org.opennaas.extension.gmpls.serviceinterface.databinding.jaxb.TerminatePathResponseType response = GmplsWS
					.terminatePath(TestGmplsWebservice.createdPathId);
