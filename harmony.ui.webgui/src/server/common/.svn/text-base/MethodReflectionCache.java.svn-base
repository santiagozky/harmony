...
/**
 * Class to speed up method lookups. <br>
 * The main performance impact in using reflections is the method lookup, as
 ...
 * <br>
 * This class uses a hashmap to hash already known methods for faster lookups. <br>
 * Using this cache in the benchmark speeds up the method lookups a lot:<br>
 * <br>
