 ...
 * @author gassen
 */
public final class GuiTopologyClient extends SimpleTopologyClient {
    ...
    private final void init() {
        this.methods.hashClassMethods(SimpleTopologyClient.class);
    }

    /**
     * @param endpointReference
     */
    public GuiTopologyClient(final EndpointReference endpointReference) {
     ...
     */
    public GuiTopologyClient(final String endpointReference)
            throws URISyntaxException {
        super(endpointReference);
