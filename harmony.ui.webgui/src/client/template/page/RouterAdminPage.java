...
import client.tools.panel.ExecuteRouterPanel;
import client.tools.panel.RefreshRouterPanel;
 ...
 * 
 */
public class RouterAdminPage extends Composite implements AsyncCallback {
    ...
    public RouterAdminPage(final ListPanel list) {

        this.table = list;

        this.top = new RefreshRouterPanel(this, list);
        this.bottom = new ExecuteRouterPanel(list);
