...
import client.helper.RemoveExecutionCallbackHandler;
...
public class ExecuteRouterPanel extends DecisionPanel {
    ...
    public ExecuteRouterPanel(final ListPanel list) {
        ...
        final RemoveExecutionCallbackHandler callback =
                new RemoveExecutionCallbackHandler(this, "Execution");
