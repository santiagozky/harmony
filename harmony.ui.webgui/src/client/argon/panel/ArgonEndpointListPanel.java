...
public class ArgonEndpointListPanel extends LinkListPanel {

    public ArgonEndpointListPanel() {
        super();
    }
    ...
    public final void refresh(final int value, final AsyncCallback callback) {
        ...
        RpcRequest.argon().getEndpoints(callback);
    ...
    public final void execute(final String type, final Vector checked,
        ...
        if (type.compareTo("Enable/Disable") == 0) {
            ...
            RpcRequest.argon().disableEndpoint(checked, callback);
            ...
            RpcRequest.argon().removeEndpoint(checked, callback);
        }
