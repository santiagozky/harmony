...
public final class Config {
    ...
    /**
     * Returns a logging level for a given key which is specified in the
     * according property file. This can be used to configure your logger using
     ...
     */
    public static Level getLevel(final String propertyFile, final String key) {

        final String levelName = Config.getString(propertyFile, key);
    ...
    public static Properties getProperties(final String propertyFile)
        ...
        final URL resource =
                Config.CLASSLOADER.getResource("properties/" + propertyFile
                        + ".properties");
    ...
    private static String getStringFromBundle(final String propertyFile,
        ...
        final ResourceBundle bundle =
                ResourceBundle.getBundle(Config.PROPERTIES_DIR + propertyFile);
