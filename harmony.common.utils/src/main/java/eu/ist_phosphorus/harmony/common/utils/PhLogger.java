...
package eu.ist_phosphorus.harmony.common.utils;
...
import eu.ist_phosphorus.harmony.common.utils.logging.PropertyWrapper;
import eu.ist_phosphorus.harmony.common.utils.logging.PhosphorusGPL;
/** NspLogger. */
public class PhLogger extends Logger {
    ...
    public static void enableSimpleLogger() {
        ...
        for (String s : map.keySet()) {
            ...
            if (!map.get(s).getOutput().equalsIgnoreCase("CONSOLE")) {
                addFileAppenderToRoot(map.get(s).getOutput(), s, Level
                        .toLevel(map.get(s).getLevel()));
            } else {
                addConsoleAppenderToRoot(map.get(s).getOutput(), s, Level
                        .toLevel(map.get(s).getLevel()));
            }
        }
    }
    ...
    private static void loadProperty() {
        ...
        if (debugMode) {
            ...
            log
                    .error("[PhLogger-debug-output] on high error-lvl to ensure to get logged, configuration-file: "
                            + url.getFile());
            log
                    .error("[PhLogger-debug-output]  debug-mode enabled, disable under utils.properties for less output");
        }
    ...
    public static Logger getLogger() {
        ...
        Logger logger = LogManager.getLogger("eu.ist_phosphorus");
...
//        }
    ...
    private static void addConsoleAppenderToRoot(String FileName,
        ...
        ConsoleAppender ca = (ConsoleAppender) addAppenderToRoot(
                new ConsoleAppender(), layout, Loggername, threshold, Logger
                        .getRootLogger());
        ca.activateOptions();
    ...
    private static void addFileAppenderToRoot(String FileName,
            String Loggername, Priority threshold) {
        addFileAppenderToLogger(FileName, Loggername, threshold, Logger
                .getRootLogger());
    }
