...
import eu.ist_phosphorus.harmony.translator.g2mpls.handler.MalleableReservationHandler;
...
public class MalleableReservationWS implements IReservationWS {
    ...
    public Element getReservation(final Element getReservation)
            throws SoapFault {
        return MalleableReservationHandler.getInstance().handle(getReservation,
                "getReservation");
    }
