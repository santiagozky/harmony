 ...
 *
 */
package eu.ist_phosphorus.harmony.test.translator.g2mpls.webservice;
...
import eu.ist_phosphorus.harmony.translator.g2mpls.webservice.ReservationWS;
...
public class TestReservationWS {
    ...
    public final void testBind() throws SoapFault {
        this.client.bind("1@"
                + Config.getString("hsiTranslatorG2MPLS", "domain.name"),
    ...
    public final void testCreateReservationWorkflow() throws SoapFault,
        ...
        final IsAvailableResponseType availResult = this.client
                .isAvailable(Config.getString("test", "test.endpoint0.tna"),
    ...
    /**
     * Test method for
     * {@link eu.ist_phosphorus.harmony.translator.g2mpls.webservice.ReservationWS#getReservations(org.w3c.dom.Element)}
     * .
     * 
     * @throws SoapFault
     * @throws DatatypeConfigurationException
