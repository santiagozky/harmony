...
package org.opennaas.extension.idb.shell;
...
public class CommandlineReservationClient {
	...
	public final String createReservation() throws SoapFault {
		...
		if (null != this.getTrunk()) {
			...
			org.opennaas.extension.idb.serviceinterface.databinding.jaxb.Tuple entry = new org.opennaas.extension.idb.serviceinterface.databinding.jaxb.Tuple();
