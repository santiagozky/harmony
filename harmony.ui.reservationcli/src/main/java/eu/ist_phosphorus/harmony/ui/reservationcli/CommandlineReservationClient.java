...
package eu.ist_phosphorus.harmony.ui.reservationcli;
...
public class CommandlineReservationClient {
	...
	public final String createReservation() throws SoapFault {
		...
		if (null != this.getTrunk()) {
			...
			eu.ist_phosphorus.harmony.common.serviceinterface.databinding.jaxb.Tuple entry = new eu.ist_phosphorus.harmony.common.serviceinterface.databinding.jaxb.Tuple();
