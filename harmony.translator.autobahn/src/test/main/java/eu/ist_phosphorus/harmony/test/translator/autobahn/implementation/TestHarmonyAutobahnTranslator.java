 ...
 */
public class TestHarmonyAutobahnTranslator {
    ...
    public static CreateReservationType createHarmonyTestReservation()
        ...
        harmonySource.setEndpointId("10.11.0.1");
        final EndpointType harmonyTarget = new EndpointType();
        harmonyTarget.setEndpointId("10.11.0.3");
    ...
    /**
     * Create a valid AutoBAHN createReservation request.
     * 
     * @return The create reservation request.
     */
    public static ResCreateContent createAutobahnTestReservation() {
     ...
     *            The Harmony request.
     */
    private void compare(final ResCreateContent autobahnRequest,
        ...
        final long expectedStartTime = autobahnRequest.getStartTime();
        Assert.assertEquals("Starttime should equal", expectedStartTime,
                actualStartTime);

        final int actualBandwidth = harmonyConnection.getMaxBW();
        final int expectedBandwidth = autobahnRequest.getBandwidth();
        ...
        final String actualSource =
                autobahnRequest.getPathInfo().getLayer2Info().getSrcEndpoint();

        Assert.assertEquals("Source endpoints should equal (by now)",
                expectedSource, this.endpointMapper.autobahnToHarmony(actualSource));

        final String expectedTarget =
                harmonyConnection.getTarget().iterator().next().getEndpointId();
        final String actualTarget =
                autobahnRequest.getPathInfo().getLayer2Info().getDestEndpoint();

        Assert.assertEquals("Target endpoints should equal (by now)",
                expectedTarget, this.endpointMapper.autobahnToHarmony(actualTarget));
    ...
    public final void testConvertCreateReservationToHarmony()
        ...
        /* Create the AutoBAHN request ------------------------------------------- */
        final ResCreateContent autobahnRequest =
                TestHarmonyAutobahnTranslator.createAutobahnTestReservation();
        /* ------------------------------------------------------------------ */

        /* Get Harmony request ---------------------------------------------- */
        final CreateReservationType harmonyRequest =
                this.translator.convert(autobahnRequest);
        /* ------------------------------------------------------------------ */

        /* Test the result -------------------------------------------------- */
        this.compare(autobahnRequest, harmonyRequest);
        /* ------------------------------------------------------------------ */
    }
     ...
     */
    @Test
    public final void testConvertCreateReservationToAutobahn()
            throws DatatypeConfigurationException, InvalidRequestException {
        /* Get Harmony request ---------------------------------------------- */
        final CreateReservationType harmonyRequest =
    ...
    public final void testConvertCreateReservationToAutobahnWithFailure()
            throws DatatypeConfigurationException, InvalidRequestException {
        /* Get Harmony request ---------------------------------------------- */
        final CreateReservationType harmonyRequest =
                TestHarmonyAutobahnTranslator.createHarmonyTestReservation();
