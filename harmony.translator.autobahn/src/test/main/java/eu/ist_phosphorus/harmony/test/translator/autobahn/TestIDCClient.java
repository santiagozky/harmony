...
public class TestIDCClient extends AbstractReservationTest {
    ...
    public void testCreateCancelReservation() throws Exception {
        ...
        final CreateReply createReply =
                this.autobahnRsvClient.createReservation(src, dst, bandwidth,
                        duration);
        this.autobahnResId = createReply.getGlobalReservationId();
        this.logger.info("Got AutoBAHN ID: " + this.autobahnResId);
        Assert.assertTrue("Should return a valid ID", null != this.autobahnResId);
        /* ------------------------------------------------------------------ */

        /* ------------------------------------------------------------------ */
        final GlobalReservationId gri = new GlobalReservationId();
        gri.setGri(this.autobahnResId);
        final ResDetails resDetails = this.autobahnRsvClient.queryReservation(gri);
