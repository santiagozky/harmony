...
/**
 * A class to simulate an AutoBAHN.
 * 
 * @author Alexander Willner (willner@cs.uni-bonn.de)
 */
public final class AutoBAHNClient extends Client {
    ...
    public AutoBAHNClient() {
        ...
        this.setMockMode(Config.isTrue("translatorAutobahn.autobahn.enableMockMode"));
        this.logger.info("Using dummy AutoBAHN calls: " + this.isMockMode());
        ...
        try {
            ...
            this.logger.error("Could not initialize AutoBAHN client: "
                    + e.getMessage(), e);
        }
    }
    ...
    public static String createReservationId() {
        return Config.getString("translatorAutobahn", "autobahn.domainID")
                + (++AutoBAHNClient.counter);
    }
    ...
    public CreateReply createReservation(final ResCreateContent resRequest)
        ...
        this.status = AutoBAHNClient.STATUS_ACTIVE;

        reply.setGlobalReservationId(AutoBAHNClient.createReservationId());
        ...
        details.setStatus(AutoBAHNClient.STATUS_ACTIVE);
    ...
    public ResDetails queryReservation(final GlobalReservationId gri)
            throws Exception {
        this.logger.info("autobahn.queryReservation: " + gri.getGri());
    ...
    public String cancelReservation(final GlobalReservationId gri)
            throws Exception {
        this.logger.info("autobahn.cancelReservation: " + gri.getGri());
        ...
        this.status = AutoBAHNClient.STATUS_CANCELLED;
        return this.status;
    }
    ...
    public CreateReply createReservation(final String src, final String dst,
        ...
        final ResCreateContent resRequest =
                AutoBAHNClient.getAutobahnTestReservationReq(src, dst, bandwidth,
                        duration);
        return this.createReservation(resRequest);
    }

    public static ResCreateContent getAutobahnTestReservationReq(
