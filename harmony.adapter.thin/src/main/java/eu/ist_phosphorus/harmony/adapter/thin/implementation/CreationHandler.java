...
import eu.ist_phosphorus.harmony.adapter.thin.database.exceptions.DestinationPortUnavailableException;
import eu.ist_phosphorus.harmony.adapter.thin.database.exceptions.PathNotFoundException;
import eu.ist_phosphorus.harmony.adapter.thin.database.exceptions.SourceAndDestinationPortUnavailableException;
import eu.ist_phosphorus.harmony.adapter.thin.database.exceptions.SourcePortUnavailableException;
...
public final class CreationHandler {
	...
	for (ServiceConstraintType sct : createReservationRequest.getService()) {
	    if (sct
		    ...
		    .equals(
			    eu.ist_phosphorus.harmony.common.serviceinterface.databinding.jaxb.ReservationType.FIXED)) {
