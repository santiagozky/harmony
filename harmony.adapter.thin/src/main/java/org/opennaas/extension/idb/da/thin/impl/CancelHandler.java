...
public final class CancelHandler {
	...
	public boolean cancelConnection(final GmplsConnection gmplsConnection)
			throws UnexpectedFaultException {
		AJaxbSerializer jser = org.opennaas.extension.idb.serviceinterface.databinding.utils.JaxbSerializer
				.getInstance();
			...
			jser.elementToObject(ContextListener
					...
					.terminatePath(
							(jser.objectToElement(gmplsConnection
									.getTerminatePathRequest(org.opennaas.extension.gmpls.serviceinterface.databinding.jaxb.StatusType.CANCELLED_BY_USER)))));
