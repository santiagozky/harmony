...
import org.opennaas.extension.idb.da.thin.persistence.exceptions.SourceAndDestinationPortUnavailableException;
import org.opennaas.extension.idb.da.thin.persistence.exceptions.SourcePortUnavailableException;
...
public final class CreationHandler {
	...
	for (ServiceConstraintType sct : createReservationRequest.getService()) {
	    if (sct
		    ...
		    .equals(
			    org.opennaas.extension.idb.serviceinterface.databinding.jaxb.ReservationType.FIXED)) {
