...
@XmlSeeAlso({
    TopologyFault.class,
    NotificationFault.class,
    InvalidRequestFault.class,
    OperationNotAllowedFault.class,
    OperationNotSupportedFault.class,
    UnexpectedFault.class,
    PathNotFoundFault.class,
    ReservationFault.class
})
public class BaseFaultType
    implements Serializable, Cloneable
{
    public BaseFaultType clone() throws CloneNotSupportedException {
        return (BaseFaultType)super.clone();
    }
