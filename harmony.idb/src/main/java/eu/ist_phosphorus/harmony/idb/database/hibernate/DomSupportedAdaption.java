...
public class DomSupportedAdaption implements java.io.Serializable,
     ...
     *                technology adaption of the domain
     */
    public DomSupportedAdaption(final Domain domainParam, final String adaptionParam) {
        super();
        this.domain = domainParam;
    ...
    public int compareTo(final DomSupportedAdaption domainAdaptionParam) {
        if (this.adaption.length() <
                               domainAdaptionParam.getAdaption().length()) {
            return -1;
    ...
    public static DomSupportedAdaption load(final long id)
    	...
    	return (DomSupportedAdaption) (new TransactionManagerLoad(DomSupportedAdaption.class, Long.valueOf(id)))
        						.getResult();
    }
    ...
    public static Set<DomSupportedAdaption> loadAll(Domain dom) throws DatabaseException {
        return (Set<DomSupportedAdaption>)(new TransactionManager(dom) {
            ...
            protected void dbOperation() {
                ...
                final List<DomSupportedAdaption> aList = this.session
                        .createCriteria(DomSupportedAdaption.class).setFetchMode("",
                                FetchMode.SELECT).add(
                                Restrictions.like("domain", d)).list();
    ...
    public String toString() {
        return "<domainAdaption><pk>" + getPK_Adaption() + "</pk><adaption>" + getAdaption() + "</adaption><domain>" + getDomain().getName() + "</domain></domainAdaption>";
    }
}
