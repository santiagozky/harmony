...
public class DomSupportedSwitch implements java.io.Serializable,
    ...
    public int compareTo(final DomSupportedSwitch domainSwitchParam) {
        if (this.switchd.length() <
                               domainSwitchParam.getSwitch().length()) {
            return -1;
    ...
    public static Set<DomSupportedSwitch> loadAll(Domain dom) throws DatabaseException {
        return (Set<DomSupportedSwitch>)(new TransactionManager(dom) {
            ...
            protected void dbOperation() {
                ...
                final List<DomSupportedSwitch> sList = this.session
                        .createCriteria(DomSupportedSwitch.class).setFetchMode("",
    ...
    public String toString() {
        return "<domainSwitch><switch>" + getSwitch() + "</switch><domain>" + getDomain().getName() + "</domain></domainSwitch>";
    }
}
