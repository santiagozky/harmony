...
public class Endpoint implements java.io.Serializable, Comparable<Endpoint> {
    ...
    private Set<InterDomainLink> interDomainLinks = new HashSet<InterDomainLink>(0);
    ...
    @OneToMany(mappedBy="sourceEndpoint",
    		   fetch=FetchType.LAZY, 
    		   cascade = {javax.persistence.CascadeType.REMOVE})
     ...
     * 
     * @param interDomainLink to be added.
     */
...
//    	result ^= ((this.getDomain() == null) ? 0 : this.getDomain().getName().hashCode());
//    	
    ...
    public static final Set<Endpoint> loadAll() throws DatabaseException {
        return (Set<Endpoint>) (new TransactionManager() {
            ...
            protected void dbOperation() {
                ...
                final List<Endpoint> tmpEndpoint = this.session.createCriteria(
                        Endpoint.class).setFetchMode("Endpoint",
            ...
            protected void dbOperation() {
                ...
                final List<VIEW_InterDomainLink> tmpSrc = this.session
                        ...
                        .setFetchMode("", FetchMode.SELECT).add(
                                Restrictions.like("sourceEndpoint", this.arg))
                        .list();
                final List<VIEW_InterDomainLink> tmpDst = this.session
                        .createCriteria(VIEW_InterDomainLink.class)
                        .setFetchMode("", FetchMode.SELECT).add(
                                Restrictions.like("destEndpoint", this.arg))
                        .list();
