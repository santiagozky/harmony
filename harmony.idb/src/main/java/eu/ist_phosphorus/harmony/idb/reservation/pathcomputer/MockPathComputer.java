...
public class MockPathComputer implements IPathComputer {
     ...
     * (non-Javadoc)
     * 
     * @see eu.ist_phosphorus.harmony.idb.reservation.IPathComputerV2#addConnection(eu.ist_phosphorus.harmony.idb.database.hibernate.Endpoint,
     ...
     * (non-Javadoc)
     * 
     * @see eu.ist_phosphorus.harmony.idb.reservation.IPathComputerV2#addService(long,
     *      long, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see eu.ist_phosphorus.harmony.idb.reservation.IPathComputerV2#computePaths(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see eu.ist_phosphorus.harmony.idb.reservation.IPathComputerV2#getPath(int, int)
     */
