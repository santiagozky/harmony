...
public class Domain implements java.io.Serializable, Comparable<Domain> {
    ...
    private Set<DomSupportedAdaption> supportedAdaptions = new HashSet<DomSupportedAdaption>(0);
    private Set<DomSupportedSwitch> supportedSwitchMatrix = new HashSet<DomSupportedSwitch>(0);
    private Set<DomSupportedBandwidth> supportedBandwidths = new HashSet<DomSupportedBandwidth>(0);
    ...
    private Set<NrpsConnections> nrpsConnections = new HashSet<NrpsConnections>(0);
    ...
    public final boolean addAdaption(final String adaption) {
        return this.getSupportedAdaptions().add(new DomSupportedAdaption(this,adaption));
    }
     ...
     * @param switchMatrix
     */
    public void setSupportedSwitchMatrix(final Set<DomSupportedSwitch> switchMatrix) {
    ...
    public final boolean addSwitch(final String switchParam) {
        return this.getSupportedSwitchMatrix().add(new DomSupportedSwitch(this,switchParam));
    }
    ...
    public final boolean addBandwidth(final long bw) {
        return this.getSupportedBandwidths().add(new DomSupportedBandwidth(this,bw));
    }
    ...
    public final int hashCode() {
        int result = this.getName().hashCode()
        				^ new Long(Helpers.trimDateToSeconds(this.getRegistered())).hashCode()
                        ^ ((this.getReservationEPR() == null) ? 0 : this
                        		.getReservationEPR().hashCode())
                        ^ ((this.getTopologyEPR() == null) ? 0 : this
                                .getTopologyEPR().hashCode())
...
//        }
    ...
    public static Domain fromJaxb(final DomainInformationType jaxb) {
        final Domain result = new Domain(jaxb.getDomainId(), jaxb
                .getDescription(), jaxb.getReservationEPR(), jaxb
                .getTopologyEPR(), jaxb.getNotificationEPR());
    ...
    public void mergeFromJaxb(final DomainInformationType jaxb) {
    	...
    	if(jaxb.getDescription() != null) this.setDescription(jaxb.getDescription());
    	this.setReservationEPR(jaxb.getReservationEPR());
    	if(jaxb.getTopologyEPR() != null) this.setTopologyEPR(jaxb.getTopologyEPR());
    	if(jaxb.getNotificationEPR() != null) this.setNotificationEPR(
    														jaxb.getNotificationEPR());
    	if(jaxb.getSequenceNumber() != null) this.setSeqNo(jaxb.getSequenceNumber());
    	if(jaxb.getRelationship() != null) this.setRelationship(
    													jaxb.getRelationship().value());
    	if(jaxb.getAvgDelay() != null) this.setAvgDelay(jaxb.getAvgDelay());
    	if(jaxb.getMaxBW() != null) this.setMaxBW(jaxb.getMaxBW());
    ...
    public static final Domain getDomainMatchingTNA(final String tna)
        ...
        return (Domain) (new TransactionManager(tna) {
            ...
            protected void dbOperation() {
                final List<TNAPrefix> tmpPrefix = this.session.createCriteria(
                        TNAPrefix.class).setFetchMode("TNAPrefix",
                ...
                if (match != null) {
                    this.result = this.session.get(Domain.class, match
                            .getDomain().getName());
                }
            }
        }).getResult();
    ...
    public static final Set<Domain> loadAll() throws DatabaseException {
        return (Set<Domain>) (new TransactionManager() {
            ...
            protected void dbOperation() {
                ...
                final List<Domain> tmpDomain = this.session.createCriteria(
                        Domain.class).setFetchMode("Domain", FetchMode.SELECT)
                        .list();
        ...
        return (Set<VIEW_InterDomainLink>) (new TransactionManager() {
            ...
            protected void dbOperation() {
                ...
                for (final Endpoint e : Domain.this.getEndpoints()) {
                    final List<VIEW_InterDomainLink> tmpSrc = this.session
                            .createCriteria(VIEW_InterDomainLink.class)
                            .setFetchMode("", FetchMode.SELECT).add(
                                    Restrictions.like("sourceEndpoint", e))
                            .list();
                    final List<VIEW_InterDomainLink> tmpDst = this.session
                            .createCriteria(VIEW_InterDomainLink.class)
                            .setFetchMode("", FetchMode.SELECT).add(
                                    Restrictions.like("destEndpoint", e))
                            .list();
    ...
    public final Set<Reservation> getAllReservations() throws DatabaseException {
        return (Set<Reservation>) (new TransactionManager(this) {
            ...
            protected void dbOperation() throws Exception {
                ...
                final List<NrpsConnections> cList = this.session
                        .createCriteria(NrpsConnections.class).setFetchMode("",
                                FetchMode.SELECT).add(
                                Restrictions.like("domain", me)).list();
    ...
    public final void delete(final Session session) {
        session.delete(this);
    }

    public final void delete() throws DatabaseException {
        /*
         * If a domain is deleted, it is useful to delete all topology
         * and reservation components related with this domain.
         * Endpoints, Links and Connections are automatically deleted by
         * foreign-key-relation in the DB. Since the relations between
         * reservations and services and a domain are not represented in
         * the DB-schema we have to do this manually. Therefore...
         */

    	List<VIEW_DomainReservationMapping> mappings =
			VIEW_DomainReservationMapping.getMappingsForDomain(this.getName());
