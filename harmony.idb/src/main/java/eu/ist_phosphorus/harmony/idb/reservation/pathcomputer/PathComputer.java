...
package eu.ist_phosphorus.harmony.idb.reservation.pathcomputer;
...
import eu.ist_phosphorus.harmony.idb.database.hibernate.VIEW_InterDomainLink;
...
public class PathComputer implements IPathComputer {
    ...
    /*
     * @see eu.ist_phosphorus.harmony.idb.reservation.IPathComputer2#addConnection(eu.ist_phosphorus.harmony.idb.database.hibernate.Endpoint,
     *      eu.ist_phosphorus.harmony.idb.database.hibernate.Endpoint, int, int)
     */
    ...
    /*
     * @see eu.ist_phosphorus.harmony.idb.reservation.IPathComputer#addService(long,
     *      long, int)
     */
    ...
    /*
     * @see eu.ist_phosphorus.harmony.idb.reservation.IPathComputer#computePaths(int)
     */
    ...
    /*
     * @see eu.ist_phosphorus.harmony.idb.reservation.IPathComputer#getPath(int, int)
     */
