...
public class TestSubscriptionRelation extends DatabaseTest {
    ...
    public void setUpBeforeEveryTest() {
        ...
        this.subscription = new Subscription("subscriptionTopic", "subscriptionEPR");
    }
...
//                loadedSub, editedSub);
        ...
        // delete
        loadedSub.delete();
        Assert.assertNull("test subscription should be deleted", Subscription
                .load(this.subscription.getSubscriptionId()));
    }
}
