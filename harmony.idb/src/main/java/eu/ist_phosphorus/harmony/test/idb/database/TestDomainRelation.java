...
import eu.ist_phosphorus.harmony.idb.database.hibernate.DomSupportedAdaption;
import eu.ist_phosphorus.harmony.idb.database.hibernate.DomSupportedBandwidth;
import eu.ist_phosphorus.harmony.idb.database.hibernate.DomSupportedSwitch;
...
import eu.ist_phosphorus.harmony.idb.database.hibernate.TNAPrefix;
import eu.ist_phosphorus.harmony.idb.exceptions.database.DatabaseException;
import eu.ist_phosphorus.harmony.idb.utils.ReservationHelpers;
import eu.ist_phosphorus.harmony.idb.utils.TopologyHelpers;
...
public class TestDomainRelation extends DatabaseTest {
    ...
    public void testSaveLoadEditDeleteRelationTuple() throws DatabaseException {
        ...
        // delete
        loadedDom.delete();
        Assert.assertNull("test Domain should be deleted", Domain
                .load(this.domain.getName()));
    }

    @Override
    public void testReferentialIntegrity() throws DatabaseException {
        // create reference endpoint and put it in the domain object
        Endpoint endpoint = TopologyHelpers.getTestEndpointForDomain(this.domain);
        ...
        Assert.assertFalse("there should be no endpoint anymore", testDom
                .getEndpoints().contains(endpoint));
        Assert.assertNull("the endpoint should be deleted", Endpoint.load(endpoint
                .getTNA()));
    ...
    public void testReferentialIntegrity2() throws DatabaseException, URISyntaxException {
        ...
        // load domain new from DB and check if TNAPrefix is not existent anymore
        testDom = Domain.load(this.domain.getName());
        Assert.assertFalse("there should be no TNAPrefix anymore", testDom
                .getPrefixes().contains(prefix));
        Assert.assertNull("the TNAPrefix should be deleted", TNAPrefix.load(prefix
        		.getPrefix()));
    ...
    @Test
    public void testReferentialIntegrity3() throws DatabaseException, URISyntaxException {
        ...
        nrpsConn.setSourceEndpoint((Endpoint)this.domain.getEndpoints().toArray()[0]);
        nrpsConn.setDestinationEndpoint((Endpoint)this.domain.getEndpoints().toArray()[1]);
        ...
        // load domain new from DB and check if nrpsConnection is not existent anymore
        testDom = Domain.load(this.domain.getName());
        Assert.assertFalse("there should be no nrpsConnection anymore", testDom
                .getNrpsConnections().contains(nrpsConn));
        Assert.assertNull("the nrpsConnection should be deleted", NrpsConnections.load(
        		nrpsConn.getPkNrpsConnection()));
    ...
    public void testReservationCleaning() throws DatabaseException {
    	...
    	Assert.assertNull(Reservation.load(res.getReservationId()));
    }
    ...
    public void testReferentialIntegrity4() throws DatabaseException {
        ...
        Domain testDom = Domain.load(this.domain.getName());
        Assert.assertNotNull("there should be DomSupportAdaptions in the domain",
        ...
        DomSupportedAdaption ad = testDom.getSupportedAdaptions().iterator().next();
        ...
        Assert.assertNull("the adaption should be deleted", DomSupportedAdaption
                .load(ad.getPK_Adaption()));
    ...
    public void testReferentialIntegrity5() throws DatabaseException {
        ...
        Domain testDom = Domain.load(this.domain.getName());
        Assert.assertNotNull("there should be DomSupportSwitches in the domain",
        ...
        DomSupportedSwitch sw = testDom.getSupportedSwitchMatrix().iterator().next();
        ...
        Assert.assertNull("the switch should be deleted", DomSupportedSwitch
                .load(sw.getPK_Switch()));
    ...
    public void testReferentialIntegrity6() throws DatabaseException {
        // create reference DomSupportedBandwidth and put it in the domain object
        ...
        Domain testDom = Domain.load(this.domain.getName());
        Assert.assertNotNull("there should be DomSupportBandwidths in the domain",
        ...
        DomSupportedBandwidth bw = testDom.getSupportedBandwidths().iterator().next();
        ...
        Assert.assertNull("the bwndwidth should be deleted", DomSupportedBandwidth
                .load(bw.getPK_Bandwidth()));
    ...
    @Test
    public void testTechnologyType() throws DatabaseException, URISyntaxException {
    	...
    	Assert.assertTrue("adaption should be the same",
    			dit2.getTechnology().getDomainSupportedAdaptation().get(0).equals(
    					dtt.getDomainSupportedAdaptation().get(0)));
    	Assert.assertTrue("bandwidth should be the same",
    			dit2.getTechnology().getDomainSupportedBandwidth().get(0).equals(
    					dtt.getDomainSupportedBandwidth().get(0)));
    	Assert.assertTrue("switch should be the same",
    			dit2.getTechnology().getDomainSupportedSwitchMatrix().get(0).equals(
