...
public abstract class DatabaseTest extends AbstractTest {
    ...
    public final void testDbProperties() throws IOException {
        ...
        config.setProperties(Config.getProperties(Constants.hibernateProperties));
        config.configure(Config.getURL(Constants.hibernateProperties, "hibernate.cfg.xml"));
    ...
    protected static Domain createReferenceDomain() throws DatabaseException {
        ...
        final Domain referenceDomain = new Domain(Helpers.getRandomString(),
                Helpers.getRandomString(), Helpers.getRandomString(), Helpers
    ...
    protected static Endpoint createReferenceEndpoint(final String domainName)
        ...
        final Endpoint referenceEndpoint = new Endpoint(TopologyHelpers
                .getRandomTNA(), Helpers.getRandomString(), Helpers
                .getRandomString(), Domain.load(domainName),
                EndpointInterfaceType.USER.ordinal(), Helpers
    ...
    protected static Service createReferenceService(final Reservation res)
        ...
        final Service referenceService = new Service(Helpers
                .getPositiveRandomInt(), res, Helpers.getPositiveRandomInt(),
                Helpers.generateXMLCalendar(10, 0).toGregorianCalendar()
                        .getTime(), Helpers.generateXMLCalendar(20, 0)
                        .toGregorianCalendar().getTime(), Helpers
                        .getPositiveRandomInt(), true);
    ...
    protected static Connections createReferenceConnection(final Service service, 
