...
import eu.ist_phosphorus.harmony.idb.webservice.ReservationWS;
...
public class TestWorkflow {
    ...
    public TestWorkflow() {
        if (Config.isTrue(Constants.testProperties, "test.callWebservice")) {
            final String resEpr = Config.getString(Constants.testProperties, "epr.reservation");
            ...
            this.reservationClient = new SimpleReservationClient(new ReservationWS());
    ...
    public void testSimpleReservationWorkflow() throws SoapFault,
        ...
        /* add dummy domain ------------------------------------------------- */
        final String resEPR = Config.getString(Constants.testProperties, "default.domain.epr");
        final String identifier = Config.getString(Constants.testProperties, "default.domain.name");
        final String TNAPrefix = Config.getString(Constants.testProperties, "default.domain.prefix");
        ...
        eu.ist_phosphorus.harmony.test.common.serviceinterface.TestWorkflow
        		.testSimpleWorkflow(this.reservationClient, this.logger, source, target, duration, bandwidth, delay);
