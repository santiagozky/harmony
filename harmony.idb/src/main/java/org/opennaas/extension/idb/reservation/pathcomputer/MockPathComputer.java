...
public class MockPathComputer implements IPathComputer {
     ...
     * (non-Javadoc)
     * 
     * @see org.opennaas.extension.idb.reservation.IPathComputerV2#addConnection(org.opennaas.extension.idb.database.hibernate.Endpoint,
     ...
     * (non-Javadoc)
     * 
     * @see org.opennaas.extension.idb.reservation.IPathComputerV2#addService(long,
     *      long, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.opennaas.extension.idb.reservation.IPathComputerV2#computePaths(int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.opennaas.extension.idb.reservation.IPathComputerV2#getPath(int, int)
     */
