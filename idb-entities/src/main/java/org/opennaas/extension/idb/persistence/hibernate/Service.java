	...
	public ServiceConstraintType toJaxb() {
		...
		if (this.getDuration() > 0) {
			if (null != this.getDeadline()) {// DeferrableReservation
				org.opennaas.extension.idb.serviceinterface.databinding.jaxb.DeferrableReservationConstraintType df = new org.opennaas.extension.idb.serviceinterface.databinding.jaxb.DeferrableReservationConstraintType();
