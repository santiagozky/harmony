...
public class MAPNRPSResvID implements java.io.Serializable {
	 ...
	 */
	public MAPNRPSResvID(final Reservation reservationParam,
			final String nrpsReservationIdParam, final Domain domainParam)
			throws InvalidReservationIDFaultException {
		this.PK_NRPSResvID = 0;
		this.reservation = reservationParam;
	...
	@Transient
	public static final List<MAPNRPSResvID> getMappingForReservation(
			final Reservation res) throws DatabaseException {
		final EntityManager session = DbConnectionManager.openSession();
		QMAPNRPSResvID mapnrpsResvID = QMAPNRPSResvID.mAPNRPSResvID;
		JPAQuery query = new JPAQuery(session);
		final List<MAPNRPSResvID> tmpMAPResConnDom = query.from(mapnrpsResvID)
