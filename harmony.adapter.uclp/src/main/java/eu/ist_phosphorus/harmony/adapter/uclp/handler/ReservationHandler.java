...
package eu.ist_phosphorus.harmony.adapter.uclp.handler;
...
import eu.ist_phosphorus.harmony.adapter.uclp.implementation.AdvReservationsWrapper;
import eu.ist_phosphorus.harmony.adapter.uclp.implementation.Session;
...
import eu.ist_phosphorus.harmony.common.serviceinterface.databinding.jaxb.ObjectFactory;
		...
		if (null != uclpResponse.getGetReservationsResponse()) {
			if (null != uclpResponse.getGetReservationsResponse()
				...
				for (ca.inocybe.argia.stubs.reservation.GetReservationsComplexType rinfo : reservationInfo) {
					...
					eu.ist_phosphorus.harmony.common.serviceinterface.databinding.jaxb.GetReservationsComplexType grsct = new eu.ist_phosphorus.harmony.common.serviceinterface.databinding.jaxb.GetReservationsComplexType();
